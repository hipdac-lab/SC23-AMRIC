...
for line in data:
    if line.startswith("Write h5plotfile time ="):
        ...
        print(f"AMRIC-SZ_L/R Total time = {number} seconds")
...
print(f"AMRIC-SZ_L/R Preprocess time = {total_pre_time} seconds")
print(f"AMRIC-SZ_L/R Writing+Compression time = {total_real_write_time} seconds")
