...
for line in data:
    if line.startswith("Write h5plotfile time ="):
        ...
        print(f"No Compression Total time = {number} seconds")
...
print(f"No Compression Preprocess time = {total_pre_time} seconds")
print(f"No Compression writing time = {total_real_write_time} seconds")
