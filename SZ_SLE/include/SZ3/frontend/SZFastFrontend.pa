...
namespace SZ {
    ...
    public:
        ...
        // T *decompress(std::vector<int> &quant_inds, T *dec_data, size_t x, size_t y, size_t z) {
...
//            write(intv_radius, c);
            ...
            write(reg_count, c);
            // std::cout << "value: " << precision << std::endl;
            // std::cout << "value: " << mean_info.use_mean << std::endl;
            // std::cout << "value: " << mean_info.mean << std::endl;
...
//            return capacity;
        ...
        size_t get_blkNum() const { 
            return conf.maxBlk; 
        }

        size_t get_num_elements() const { 
            return conf.totalLength; 
...
//                bool enable_regression = params.use_regression_linear && min_size >= 1;
                        ...
                        *indicator_pos = selection_result;
                        ...
                        // std::cout << "selection_result::::::: " << selection_result << std::endl;
...
//        meta_decompress_3d(const unsigned char *compressed, size_t r1, size_t r2, size_t r3) {
        T *decompress_3d(std::vector<int> &quant_inds, T *dec_data) {
            // std::cout << "111: " << params.lorenzo_padding_layer << std::endl;
            // std::cout << "111: " << params.regression_param_eb_independent<< std::endl;
