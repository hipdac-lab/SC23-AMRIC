...
//	printf("nbEle=%u\n", nbEle);
    ...
    SZ_errConfigToCdArray(&cd_nelmts, &cd_values, 1, 8, 0.001, 0,
                          nbEle); //SZ_FLOAT or SZ_DOUBLE or SZ_INT 100x500x500 : 0, 0, 100, 500, 500, ABS, REL (0.01, 0.01*(max-min), PW_REL (0.01, 5, 6, 7, 8, 9 --> 5*0.01, 6*0.01, ...), PSNR (mean squared error)).
