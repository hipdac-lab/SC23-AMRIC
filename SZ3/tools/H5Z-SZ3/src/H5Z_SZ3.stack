...
static herr_t H5Z_sz3_set_local(hid_t dcpl_id, hid_t type_id, hid_t chunk_space_id) {
    ...
    // for (size_t i = 0; i < cd_nelmts; i++)
        // {
        //      printf("cd_values=%u ", cd_values[i]);
        // }
        // printf("\n");
    ...
    if (flags & H5Z_FLAG_REVERSE)
    {
        ...
        case SZ_DOUBLE: //DOUBLE
        {
            ...
            if (realLength > 0) {
                ...
                memcpy(d_decompressedData, realData, realLength * sizeof(double));
                delete[] realData;
            }
            free(*buf);
        ...
        //     sum+=((double *)*buf)[i];
        // std::cout << "frist data in H5Z_filter_sz3: " << ((double *)*buf)[0] << std::endl;
        // std::cout << "sum of data in H5Z_filter_sz3: " << sum << std::endl;
        ...
        /*bs*/
        // printf("szfliter comp using bs, r1=%u, r2=%u, r3=%u, r4=%u, r5=%u\n", r1, r2, r3, r4, r5);

                // /*1d*/
                //printf("szfliter comp using 1d, chunkSize=%u, r1=%u, r2=%u, r3=%u, r4=%u, r5=%u\n", chunkSize, r1, r2, r3, r4, r5);
       ...
       // r3 = r1/(r2*r2);
       // r1 = r2;
        //      printf("sz3Flite comp using ori nast linear, chunkSize=%u, r1=%u, r2=%u, r3=%u, r4=%u, r5=%u\n", chunkSize, r1, r2, r3, r4, r5);

                /*stack*/
                // size_t unitBlkSize = BSIZE*BSIZE*BSIZE;
        // size_t bigX = abs_error;
                // size_t bigZ = r1/(bigX*bigX*unitBlkSize);
                // r3 = BSIZE*bigZ;
                // r2 = BSIZE*bigX;
                // r1 = BSIZE*bigX;
         r2 = abs_error;
         r3 = r1/(r2*r2);
         r1 = r2;
                 //printf("szfliter comp using stack, chunkSize=%u, r1=%u, r2=%u, r3=%u, r4=%u, r5=%u\n", chunkSize, r1, r2, r3, r4, r5);
